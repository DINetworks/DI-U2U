...
export default function BridgeTransactionStatusDialog({
  ...
  const getSteps = (tx: BridgeTransaction): Step[] => {
    ...
    return [
      ...
      },
      {
        ...
        destinationTxHash: destinationCompleted
  ...
  const isCrossChain =
    transaction.type === "sendToken" ||
    transaction.type === "callContract" ||
    transaction.type === "callContractWithToken";
      ...
      <ModalContent>
        <ModalHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3
                className={`text-xl font-bold ${isCompleted ? "text-green-600" : isFailed ? "text-red-600" : "text-blue-600"}`}
              >
                {isCompleted
                  ? isCrossChain
        ...
        <ModalBody className="space-y-6">
                ...
                <div key={step.id} className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {step.txHash && step.chainName && (
                      <div className="mt-2">
                        <button
                          ...
                          onClick={() =>
                            window.open(
                              getExplorerUrl(step.chainName!, step.txHash!),
                              "_blank",
                            )
                          }
                        >
                    ...
                    {step.destinationTxHash &&
                      step.chainName &&
                      step.destinationTxHash.length > 0 && (
                        <div className="mt-2">
                          <button
                          ...
                          >
                            {step.destinationTxHash.slice(0, 10)}...
                            {step.destinationTxHash.slice(-8)}
                          </button>
                        </div>
                      )}
                  </div>
          ...
          <div className="text-center text-sm text-gray-600 dark:text-gray-400">
            {isCompleted ? (
              ...
              <>
                ⏳ Please wait while your transaction is being processed across
                chains...
              </>
            )}
          </div>
        ...
        <ModalFooter>
          <Button
            className="w-full"
            color={isCompleted ? "success" : isFailed ? "danger" : "primary"}
            onPress={onClose}
          >
